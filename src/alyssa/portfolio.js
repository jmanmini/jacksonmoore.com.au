        ...
        <div>
            ...
            <div style={{ marginTop: '64px', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', height: 'calc(100vh - 64px)' }} data-background-color='rgb(255, 255, 255)' className='js-color-stop'>
                <div style={{ maxWidth: '1150px', display: 'flex', flexWrap: 'wrap' }}>
                    ...
                    <div style={{ maxWidth: '500px', minHeight: '200px', overflow: 'wrap', flex: '1 0 300px', margin: '16px', fontFamily: 'Roboto' }}>
            ...
            <div style={{ paddingTop: '64px', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', height: 'calc(100vh - 64px)' }} data-background-color='rgb(-10, -10, -10)' className='js-color-stop'>
                <div style={{ maxWidth: '1150px', display: 'flex', flexWrap: 'wrap', flexDirection: 'row-reverse' }}>
                    <Card style={{ maxWidth: '350px', minWidth: '350px', backgroundColor: 'white', margin: '8px', borderRadius: '12px' }}>
                        <CardActionArea>
                            <CardMedia
                                component='img'
                    ...
                    <div style={{ maxWidth: '500px', minHeight: '200px', overflow: 'wrap', flex: '1 0 300px', margin: '16px', fontFamily: 'Roboto', color: 'white', textAlign: 'right' }}>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel neque in libero facilisis vulputate. Etiam eu mauris eu est rhoncus rutrum eu nec enim. Phasellus efficitur lacus vel purus gravida, varius congue ipsum gravida. Nulla aliquam, augue vitae ultrices maximus, elit enim congue leo, eu bibendum risus quam a sem. Nam non molestie nibh. Quisque eros dui, cursus a felis euismod, finibus blandit leo. Nullam et tellus non urna volutpat dignissim. Cras varius viverra elit a convallis. Curabitur pretium scelerisque nisi, vel varius eros pretium porttitor. Pellentesque ac turpis ornare, ornare lacus sit amet, tempus nunc.
                </div>
                </div>
            </div>
