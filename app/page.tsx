        ...
        <div>
            ...
            <div className="z-0 relative">
                ...
                <div className="container mx-auto z-0 columns-1 px-6 pt-20">
                    <h1 className="pb-8 text-transparent text-8xl tracking-tighter font-bold font-[var(--font-league-spartan)] bg-clip-text bg-gradient-to-r from-blue from-20% to-yellow to-40%">Jackson Moore</h1>
