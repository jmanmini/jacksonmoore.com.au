    ...
    return (
        <div
            ...
            <div
                ...
                I do
                <Typed
                    strings={['art', 'long art', 'real long art']}
                    typeSpeed={40}
                    backSpeed={50}
                    loop
                    style={{
...
function PortfolioBrief() {
    return (
        <div
            ...
            <TrackVisibility>
                {({ isVisible }) => <Fade in={isVisible} {...(isVisible ? { timeout: 1000 } : {})}>
                    <h1 style={{
                        marginLeft: '10%'
                    }}>Portfolio Work</h1>
                </Fade>}
            ...
            <div
                ...
                <TrackVisibility offset={400}>
                    <PortfolioCardHome duration={500} num={1}></PortfolioCardHome>
                </TrackVisibility>
                <TrackVisibility offset={400}>
                    <PortfolioCardHome duration={1000} num={2}></PortfolioCardHome>
                </TrackVisibility>
                <TrackVisibility offset={400}>
                    <PortfolioCardHome duration={1500} num={3}></PortfolioCardHome>
                </TrackVisibility>
            </div>
        </div >
    )
...
class PortfolioCardHome extends React.Component {
    ...
    componentDidMount() {
        ...
        firebase
            .database()
            .ref('/alyssa/portfolioCards/Card' + this.props.num)
            .on('value', data => {
                this.setState({
                    title: data
                        .val()
    ...
    render() {
        return (
            <Grow
                ...
                {...(this.props.isVisible ? { timeout: this.props.duration } : {})}>
